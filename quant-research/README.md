...
[모드 2 전용 GitHub Actions](../.github/workflows/mode2-daily.yml)는 평일 16:19·16:34·16:49 KST에 완료 일봉을 재확인하고 루트 README의 관찰 패널을 갱신합니다. 수동 `Run workflow`도 지원합니다. 자동 패널은 **3팩터·브레드스만** 사용하며 SUE 가산점과 실적 촉매 핫스왑은 포함하지 않습니다. 새 완료 일봉이 없으면 마지막 확인 일봉 기준 판단 순위와 상위 10종목 관찰표를 날짜와 함께 보여주되, 새 월간 계획을 저장하지 않습니다.
