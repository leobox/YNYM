...
> 일봉 기준 `2026-09-23` · 확인 `2026-09-25 16:25 KST` · 유효 종목 `138/150` · 자격 통과 `33종목` · Breadth(SMA60 위) `53.6%` · **새 일봉 전까지 판단 보류**
...
|---:|:---|:---|
| 1 | **코스맥스** (192820)<br>272,000원 · **0.936** | 60→5거래일 수익률 **+76.3%** · 변동성 조정 모멘텀 **1.24** · CMF20 **+0.12**<br>점수 기여: 위험조정 0.400 + 추세 0.300 + CMF 0.236<br>회사 참고: 화장품 ODM 개발·제조 사업 ([공식 자료](https://www.cosmax.com/en/), 2026-09-25 확인) |
| 2 | **한미사이언스** (008930)<br>52,100원 · **0.858** | 60→5거래일 수익률 **+71.2%** · 변동성 조정 모멘텀 **0.85** · CMF20 **+0.07**<br>점수 기여: 위험조정 0.376 + 추세 0.291 + CMF 0.191<br>회사 참고: 한미그룹의 사업형 지주회사 ([공식 자료](https://sustainability.hanmiscience.co.kr/2025/en/ourcompany/companyintroduction), 2026-09-25 확인) |
| 3 | **JB금융지주** (175330)<br>30,150원 · **0.788** | 60→5거래일 수익률 **+32.6%** · 변동성 조정 모멘텀 **0.64** · CMF20 **+0.13**<br>점수 기여: 위험조정 0.315 + 추세 0.227 + CMF 0.245 |
| 4 | **한국콜마** (161890)<br>147,000원 · **0.782** | 60→5거래일 수익률 **+50.9%** · 변동성 조정 모멘텀 **0.67** · CMF20 **+0.04**<br>점수 기여: 위험조정 0.327 + 추세 0.273 + CMF 0.182<br>회사 참고: 화장품 ODM 사업 ([공식 자료](https://www.kolmar.co.kr/about/summary.php), 2026-09-25 확인) |
| 5 | **현대해상** (001450)<br>47,550원 · **0.752** | 60→5거래일 수익률 **+39.8%** · 변동성 조정 모멘텀 **0.73** · CMF20 **+0.02**<br>점수 기여: 위험조정 0.352 + 추세 0.264 + CMF 0.136 |
...
> ⏱️ **수집 시각**: `2026-09-25 14:40 KST (15분 예약 주기)` | 📊 **감시 유니버스**: `350종목`
