...
- [모드 2 전용 GitHub Actions](.github/workflows/mode2-daily.yml): 평일 16:19·16:34·16:49 KST에 완료 일봉을 재확인하고 아래 관찰 패널을 갱신합니다. Actions 화면의 `Run workflow`로 수동 실행할 수 있습니다. 새 완료 일봉이 없어도 마지막 확인 일봉(현재 9월 23일)의 판단 순위와 상위 10종목 관찰표를 기준일과 함께 표시합니다. 새 월간 계획이나 체결을 기록하지 않습니다.
...
> 일봉 기준 `2026-09-23` · 확인 `2026-09-26 16:52 KST` · 유효 종목 `138/150` · 자격 통과 `33종목` · Breadth(SMA60 위) `53.6%` · **새 일봉 전까지 판단 보류**
