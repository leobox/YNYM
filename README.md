...
> `quant-research` VCP(변동성 축소 패턴) 스캐너가 한국 장중 2시간 주기로 자동 갱신합니다. 5중 안전 기준(이평 정배열, 2~3차 변동성 수축, 피봇 돌파, 수급 폭발, 이격 제한) 통과 종목을 실시간 추적합니다. 전체 스냅샷 및 보고서는 [`quant-research/data/vcp_snapshots/`](quant-research/data/vcp_snapshots/)를 참고하세요.

<!-- VCP_DASHBOARD:START -->

> **최근 스캔**: `2026-09-20 11:39 KST` | **유니버스 분석**: `150종목` | **최종 후보(돌파)**: `0건` | **관찰 종목(수축)**: `5건`
