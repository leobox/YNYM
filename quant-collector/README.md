...
> **최근 스캔**: `2026-09-17 19:58 KST` | **유니버스**: `150종목` | **조건 충족**: `0건` | **관찰**: `0건` | **보유 추적**: `2건`
...
|:---:|:---|:---:|:---:|:---:|:---|
| **⚠️ 손절·탈출** | **한화엔진** (082740) | 53,200원 | **53,700원 (+0.94%)** | `BREAKOUT_COLLAPSE` | 돌파 기준선(53,200원) 종가 하향 이탈! 가짜 돌파로 판단하여 조기 손절(+0.94%) |
...
|:---|:---:|:---:|:---:|:---:|:---:|:---|
| **한화엔진** (082740) | 53,200원 | 53,700원 (**+0.94%**) | +0.9% | 53,200원 | **🔴 SELL (손절)** | 돌파 기준선(53,200원) 종가 하향 이탈! 가짜 돌파로 판단하여 조기 손절(+0.94%) |
| **케이씨텍** (281820) | 73,300원 | 72,700원 (**-0.82%**) | +0.3% | 71,100원 | **🟢 HOLD** | 돌파선 위에서 양호하게 상승 추세 유지 중 |
