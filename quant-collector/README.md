...
> **최근 스캔**: `2026-09-18 09:56 KST` | **유니버스**: `150종목` | **조건 충족**: `0건` | **관찰**: `0건` | **보유 추적**: `2건`
...
|:---|:---:|:---:|:---:|:---:|:---:|:---|
| **한화엔진** (082740) | 53,200원 | 52,200원 (**-1.88%**) | +0.9% | 53,200원 | **🟠 RECHECK (다음 봉 확인)** | 돌파 기준선(53,200원) 근접 이탈(-0.38%). 확정 붕괴로 보기엔 애매해 다음 봉 재확인 필요 |
| **케이씨텍** (281820) | 73,300원 | 72,500원 (**-1.09%**) | +0.3% | 71,100원 | **🟢 HOLD** | 돌파선 위에서 양호하게 상승 추세 유지 중 |
